                          ...
                          children: [
                            ...
                            OptionRow(onPressed: (){
                              showDialog(context: context, builder: (context){
                                ...
                                return AlertDialog(title: Text('Are you sure?'),content: Text('Stay Logged and check our new collections'),actions: [   TextButton(
                                              onPressed: () {},
                                              child: Text(
                                                'Logout',
                                                style: TextStyle(
                              ...
                              ,setIcon: Icons.logout, setText: 'Logout'),
                          ],
                        ),
                      ),
                    ),
